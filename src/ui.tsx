...
import { LightbulbItem, ToggleWidget } from "./types";
import styles from "./styles.css";
import { eye, menu, colors } from "./icons";
        ...
        <div>
          <div class={styles["sidebar-container"]}>
            ...
            >
              ...
              <span class={styles["parent-title"]}>{obj.parentNode.name}</span>
            </div>
              ...
              answer.answered ? (
                <div className={styles["answer-container"]}>
                  ...
                  <div className={styles["category-row"]}>
                    ...
                    <span>
                      {tab == "Categories" ? answer.category : answer.question}
                    </span>
                  </div>
